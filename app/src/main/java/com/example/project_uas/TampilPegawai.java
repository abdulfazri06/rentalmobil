...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showEmployee(String json){
        try {
            ...
            String sal = c.getString(konfigurasi.TAG_KONDISI);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_KONDISI,salary);
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(TampilPegawai.this,TampilSemua.class));
                    }
                });
